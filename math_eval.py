...
def main(
    ...
    #check if either prompt or dataset_path is provided
    assert prompt is not None or dataset_path is not None, "Either prompt or dataset_path must be provided"
    global print
    ...
    if isinstance(prompt, int):
        ...
        prompt = torch.randint(0, 1024, (prompt,), device=device, dtype=torch.int64)
    ...
    for i in range(start, num_samples):
        ...
        print("Tokens to decode:", y[0].tolist())
        print()
...
if __name__ == '__main__':
    ...
    main(
        args.prompt, args.dataset_path, args.interactive, args.num_samples, args.max_new_tokens, args.batch_size, args.top_k,
        args.top_p, args.temperature, args.checkpoint_path, args.compile, args.compile_prefill, args.profile, 
